...
* В аспекте *PHYSICAL:CONSTRUCTION:ROLE* допустимо попадание некоторых конструкций и мебели («стремянка», «гильотина») в класс *APARTMENT*. Для отделения помещений следует использовать атрибут *ATTR:PHYSICAL:CONTAINER:CLASS*, маркирующий помещения как *CONFINED_SPACE* («замкнутое пространство»);
